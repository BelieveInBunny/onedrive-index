...
(here, [Team Drive site](https://octavian.akeno.workers.dev), you can't see the files/folders indexed, but [Test folder](https://octavian.akeno.workers.dev/test), here you can)
...
<image align="right" src="assets/animesub.png" alt="AnimeSub" width="125px" />
...
Live demo: [📁 AnimeSub's OneDrive Index](https://storage.spencerwoo.com/).
...
[@Portfolio](https://animesub.in/) · [@Blog](https://blog.spencerwoo.com/) · [@GitHub](https://github.com/spencerwooo)
